...
namespace Duplikatserkennung
{
    public partial class Form1 : Form
    {
        ...
        private void AnalysiereOrdner(string ordnerPfad)
        {
            ...
            foreach (var datei in dateien)
            {
                try
                {
                    string hash = BerechneSHA256(datei);
        ...
        private void ZeigeAlleDateien(string ordnerPfad)
        {
            ...
            var dateien = Directory.GetFiles(ordnerPfad, SearchOption.AllDirectories);
            var alleDateien = new List<FileData>();
        ...
        private void ZeigeDateien(List<FileData> dateien)
        {
            listviewDuplicates.Items.Clear();
        ...
        private void btnLoeschen_Click(object sender, EventArgs e)
        {
            ...
            // Optional: kompletten Pfad speichern, falls du den irgendwo brauchst
            // Aktuell hast du ja nur Dateiname in ListView, keinen vollständigen Pfad.
            // Wenn du den Pfad brauchst, müsste der beim Anzeigen der Duplikate mit gespeichert werden.

            // Hinweis: Da du aktuell nur den Dateinamen in der ListView anzeigst,
            // und nicht den kompletten Pfad, müssen wir den Pfad irgendwie rekonstruieren.
            // Am einfachsten: Im Tag-Property des ListViewItems den kompletten Pfad speichern.
